...
import 'package:quiz_app/controllers/authentication/login_controller.dart';
import 'package:quiz_app/pages/authentication/register_page.dart';
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: Padding(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Explore some interesting quizzes",
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
          ...
          Positioned(
            ...
            child: Container(
              height:
                  MediaQuery.of(context).size.height * 0.75, // 3/4 tinggi layar
              decoration: const BoxDecoration(
                color: Colors.white, // Atur warna latar belakang menjadi merah
